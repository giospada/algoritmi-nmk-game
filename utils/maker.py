...
def name_to_classname(name):
    ...
    if name == 'random':
        ...
        return 'mnkgame.mics.MicsPlayerFixed'
...
def make_command(args):
    ...
    if args.human:
        ...
        return f"java -Xmx8G mnkgame.MNKPlayerTester {args.board[0]} {args.board[1]} {args.board[2]} {player1} {player2} -r {args.rounds} -t {args.time} {verbose}"
